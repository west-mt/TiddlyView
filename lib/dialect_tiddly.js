  ...
  block: {
    ...
    lists: (function( ) {
      ...
      var any_list = "[*+#-]",
          ...
          is_list_re = new RegExp( "^()(" + any_list + ")[ \t]+" ),
          indent_re = "(?: {0,3}\\t| {4})";
          ...
          for ( var line_no = 0; line_no < lines.length; line_no++ ) {
			...
			if(m){
			  ...
			  if(depth > last_depth){
				...
				var inline = this.processInline(l.substr(m[0].length));
            ...
            if (m && m[1] !== undefined ) {
              ...
              var wanted_depth = m[1].length;
              //print( "want:", wanted_depth, "stack:", stack.length);
              //alert( "want:" + wanted_depth + " stack:" + stack.length);
            ...
            // Add content
			if(m){
			  li_accumulate += l.substr( m[0].length );
